...
NicheDE_Obj = niche_DE(NicheDE_Obj, outfile=paste0("/data/cephfs-2/unmirrored/projects/liposarcoma-wgs/Niche_DE_Rang20/20240923_NicheDE/20240924_NicheDE_PostNicheDE_Region",xR,".rds"), num_cores = 3, batch = T)
